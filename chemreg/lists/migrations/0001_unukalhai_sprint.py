...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('substance', '0001_unukalhai_sprint'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_description', chemreg.common.models.HTMLTextField(max_length=1000)),
                ('long_description', chemreg.common.models.HTMLTextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', models.CharField(default=chemreg.lists.utils.build_rid, max_length=50, primary_key=True, serialize=False, unique=True)),
